...
function loadTournament(tournamentId) {
  ...
  const players = [
    ...tournament.matches[0]?.players.map(player => player?.displayName),
    ...tournament.matches[1]?.players.map(player => player?.displayName)
  ];
  
  console.log(players);
  // console.log(tournament.matches[0]?.players[0]?.displayName);
  // console.log(tournament.matches[0]?.players[1]?.displayName);
