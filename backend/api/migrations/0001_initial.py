# Generated by Django 5.1.1 on 2024-11-24 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player1', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='player1_matches', to='api.player')),
                ('player2', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='player2_matches', to='api.player')),
                ('player3', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='player3_matches', to='api.player')),
                ('player4', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='player4_matches', to='api.player')),
                ('winner1', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winner1_matches', to='api.player')),
                ('winner2', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winner2_matches', to='api.player')),
